...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_spaceship p_spaceship;
        ...
        public static SteamVR_Input_ActionSet_spaceship spaceship
        {
            get
            {
                return SteamVR_Actions.p_spaceship.GetCopy<SteamVR_Input_ActionSet_spaceship>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_spaceship = ((SteamVR_Input_ActionSet_spaceship)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_spaceship>("/actions/spaceship")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.spaceship};
        }
    }
}
